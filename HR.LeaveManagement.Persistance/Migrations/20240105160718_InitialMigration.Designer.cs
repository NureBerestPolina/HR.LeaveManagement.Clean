...
namespace HR.LeaveManagement.Persistance.Migrations
{
    ...
    [Migration("20240105160718_InitialMigration")]
            ...
            modelBuilder.Entity("HR.LeaveManagement.Domain.LeaveType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            DateCreated = new DateTime(2024, 1, 5, 16, 7, 18, 7, DateTimeKind.Utc).AddTicks(5888),
                            DateModified = new DateTime(2024, 1, 5, 16, 7, 18, 7, DateTimeKind.Utc).AddTicks(5892),
                            DefaultDays = 10,
                            Name = "Vacation"
                        });
                });
